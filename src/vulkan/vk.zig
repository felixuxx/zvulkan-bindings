...
pub const PFN_vkCmdBeginRenderPass2 = *const fn (CommandBuffer, *const types.RenderPassBeginInfo, *const core_1_2.SubpassBeginInfo) callconv(.c) void;
pub const PFN_vkCmdEndRenderPass2 = *const fn (CommandBuffer, *const core_1_2.SubpassEndInfo) callconv(.c) void;
